...
void TestDX::Test()
{
	...
	DXAssetsManager::Get()->GetAssetsConstantBuffer("shaders_0").CreateConstantBufferss(mObj.size() + 1);
	...
	////////////////
	//mTextures["bricks"]->Resource->Release();
	////mTextures["bricks"]->UploadHeap->Release();
...
void TestDX::HandleWindowsCallback(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg)
	{
...
void TestDX::OnUpdate(float deltaTime)
{
