...
public:
	...
	*/
	...
	//ID3D12GraphicsCommandList*						mVecMultithreadCMDList[32];
	//ID3D12CommandAllocator*							mVecMultithreadCMDAllocator[32];
...
public:
	...
	//ComPtr<ID3D12CommandAllocator>			mpCommandAllocator;//command list에 추가된 명령들은 이 Allocator의 메모리에 저장이 된다.
